...
user in an INI file next to IcarTestPortable.exe called IcarTestPortable.ini.
...
copy AppNamePortable.ini from this directory to IcarTestPortable.ini next to
IcarTestPortable.exe. The options in the INI file are as follows:
